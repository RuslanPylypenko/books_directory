...
final class Version20240125063449 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Added author table, books and relation';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE book (id INT NOT NULL, name VARCHAR(255) NOT NULL, short_description TEXT DEFAULT NULL, image VARCHAR(255) NOT NULL, publish_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
